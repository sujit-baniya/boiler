...
use App\Services\Media\Jobs\PerformConversions;
...
trait HasMedia
{
    ...
    public function getMediaUrlList(string $group = 'default', string $conversion = '')
    {
        $mediaList = $this->getMedia($group);
        $urlList = [];
        foreach($mediaList as $media)
        {
            $urlList[] = $media->getUrl($conversion);
        }
        return $urlList;
    }

    public function getMediaUrl(string $group = 'default', string $conversion = '')
    {
